...
def app():    
    ...
    def add_multilingual_stopwords() -> Dict:
        ...
        """
        multilingul_list = []
        for file in os.listdir(r'D:/Projects/Streamlit_webapp/Whatsapp/configs/stopwords'):
            stopword = open(r'D:/Projects/Streamlit_webapp/Whatsapp/configs/stopwords/' + file, "r",encoding='utf8')
    ...
    """
    # Parsing YAML file
    config = r'D:/Projects/Streamlit_webapp/Whatsapp/configs/app_configuration.yml'
    ...
    if c2.button("Try Demo"):
        with open(r'D:/Projects/Streamlit_webapp/Whatsapp/configs/demo_chat.txt', 'r',encoding="utf8") as read_file:
            data = read_file.read()
        file_process(data, config)
